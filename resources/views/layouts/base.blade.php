...
<head>
    ...
    <meta name="description" content="Boğaziçi University Bright description">
    <meta name="author" content="Boğaziçi University Bright">
...
<body data-spy="scroll" data-target="#sidebar-nav" data-offset="15">

    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="row align-items-center navbar-header page-scroll">
                                <a class="navbar-brand" href="#">
                             <img class="img-responsive" alt="Brand" src="{{ asset('img/b.png') }}">
                                  </a>
            ...
            <div class="row align-items-center collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p class="copyright text-muted">Copyright &copy; Bright 2017</p>
                </div>
            </div>
        </div>
    </footer>
